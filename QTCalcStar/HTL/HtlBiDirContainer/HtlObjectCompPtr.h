...
*/
#pragma once
#ifndef HTLOBJECT_COMPOSITEPTR_H
#define HTLOBJECT_COMPOSITEPTR_H
#include "..\modHtlBase.h"
#include "..\modHtlGUID.h"
namespace HTL
{;
	class HtlObject;
//HtlObject Composite Pointer TypeDef
	class HTL_DLLAPI HtlObjectCompPtr
		: public HtlBase
	{
	public:

		HtlObjectCompPtr();
		HtlObjectCompPtr(const HtlObjectCompPtr& rhs);
		virtual ~HtlObjectCompPtr();
		...
		HtlObjectCompPtr & operator = (const HtlObjectCompPtr & rhs);

		HtlObjectCompPtr & operator = (HtlObject* & rhs);

		HtlObjectCompPtr & operator = (HtlObject* rhs);

		HtlObjectCompPtr & operator = (HtlGUID128 & rhs);
...
#endif //#ifndef HTLOBJECT_COMPPTR_H
