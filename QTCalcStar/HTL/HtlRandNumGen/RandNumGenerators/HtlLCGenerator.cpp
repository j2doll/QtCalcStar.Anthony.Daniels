...
#include ".\HtlLCGenerator.h"
#include <time.h>

namespace HTL{
	//!HtlRandNumGen VOID Constructor
	HtlLCGenerator::HtlLCGenerator(void)
	{
	...
	void HtlLCGenerator::initialize(void)
	{
	...
	double HtlLCGenerator::next(void)
	{
      while (m_blnLocked)
      {
         //spin;
