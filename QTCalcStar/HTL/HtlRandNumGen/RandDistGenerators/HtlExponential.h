...
#ifndef HTL_EXPONENTIAL_H
#define HTL_EXPONENTIAL_H
...
namespace HTL
{
	...
	*/
	...
	class HTL_DLLAPI HtlExponential : public HtlRandNumDist
	{
	...
	public:
		...
		*/
		virtual ~HtlExponential();

		//!Distribution Stretch value, must be Beta > 0.0f (very important)
