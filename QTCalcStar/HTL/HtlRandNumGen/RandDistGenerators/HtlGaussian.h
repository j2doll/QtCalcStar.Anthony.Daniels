...
#ifndef HTL_GAUSSIAN_H
#define HTL_GAUSSIAN_H
...
namespace HTL
{
	...
	*/
	...
	class HTL_DLLAPI HtlGaussian : public HtlRandNumDist
	{
	...
	public:
		...
		*/
		...
		HTLMEMVAR_BYREF_STYLE1(public, double, dblMean);
		//!Distribution Sigma Value
		HTLMEMVAR_BYREF_STYLE1(public, double, dblSigma);	
