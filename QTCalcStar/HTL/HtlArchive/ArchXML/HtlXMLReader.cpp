...
HtlXMLReader::HtlXMLReader(void)
{
...
int HtlXMLReader::LoadXMLElement(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{	
	/*
	//READELEMENT
...
int HtlXMLReader::LoadOpenTag(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex, bool & blnNullElementReturn)
{
	int intTemp;
...
//Load the Tag to the Element Name
int HtlXMLReader::LoadCloseTag(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	return -1;
};

//Load the Attributes into the Element
int	HtlXMLReader::LoadAttributes(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
...
//Load the Attributes into the Element
int	HtlXMLReader::LoadValue(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	//makes the assumption that the open tag has been established.
	//take the tag string minus open and close characters
	//Parse the attributes into a name,value pair vector stripping the "" or '' around the value and the = sign
...
//Load the Attributes into the Element
int	HtlXMLReader::LoadSubNodes(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	//makes the assumption that the open tag has been established.
	//take the tag string minus open and close characters
	//Parse the attributes into a name,value pair vector stripping the "" or '' around the value and the = sign
...
int	HtlXMLReader::LoadSubElement(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
...
int	HtlXMLReader::LoadComment(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	std::string strValTemp;
	int intReturn = 1;
...
int	HtlXMLReader::LoadProcess(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	std::string strValTemp;
	int intReturn = 1;
	size_t intStartPos, intEndPos;
...
int HtlXMLReader::LoadProcessOpenTag(HtlElement * ptrElement, const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	int intReturn;
...
int	HtlXMLReader::LoadProcessAttributes(HtlElement * ptrElement,const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
	//makes the assumption that the open tag has been established.
	//take the tag string minus open and close characters
	//Parse the attributes into a name,value pair vector stripping the "" or '' around the value and the = sign
...
int	HtlXMLReader::LoadProcessValue(HtlElement * ptrElement,const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
...
long HtlXMLReader::FindNextTagStart(const std::string & strInput,size_t intStartPos, bool & blnCloseTag)
{
...
long HtlXMLReader::FindNextNWSLChar(const std::string & strInput,size_t intStartPos)
{
...
long HtlXMLReader::FindNextNWSChar(const std::string & strInput,size_t intStartPos)
{
	long intCursor, lngStringSize;
	//skip through primary white space and illegal characters
	lngStringSize = strInput.size();
...
long HtlXMLReader::FindNextWSChar(const std::string & strInput,size_t intStartPos)
{
	long intCursor,lngStringSize;
...
long HtlXMLReader::FindNextQuote(const std::string & strInput,size_t intStartPos)
{
	long intCursor, lngStringSize;
	//cycle until white space found
	lngStringSize = strInput.size();
...
//!Find Next White Space Character
long HtlXMLReader::FindNextChar(const std::string & strInput,size_t intStartPos, char chrFind)
{
...
bool HtlXMLReader::IsNodeComment(const std::string & strInput,size_t intStartPos)
{
	if((intStartPos + 3) < strInput.size())
	{//then safe to check as a comment
		if((strInput[intStartPos] == '<')&&
...
bool HtlXMLReader::IsNodeProcess(const std::string & strInput,size_t intStartPos)
{
	if((intStartPos + 1) < strInput.size())
	{//then safe to check as a process
		if((strInput[intStartPos] == '<')&&
...
bool HtlXMLReader::IsNodeElement(const std::string & strInput,size_t intStartPos)
{
	if((intStartPos + 1) < strInput.size())
	{//then safe to check as a process
		if( (strInput[intStartPos] == '<')&&
...
void HtlXMLReader::CleanNameString(std::string & strName)
{
...
int HtlXMLReader::LoadXMLTree(HtlElement * ptrCurrTop,const std::string & strInput, HtlElementIndex & objCurrElementIndex)
{
...
int HtlXMLReader::LoadXMLTree(HtlElement * ptrCurrTop, std::istream & strStreamInput)
{
	int intTemp, intReturn;
...
int HtlXMLReader::LoadXMLTree(HtlElement * ptrCurrTop, std::ifstream & strStreamInput)
{
	int intTemp, intReturn;
	std::string strFileInput;
	intReturn = 1;
...
//!Update the indexes
//int HtlXMLReader::UpdateIndexes(void)
//{
