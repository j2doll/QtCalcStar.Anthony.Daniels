...
#pragma once
#ifndef HTL_XMLWRITER_H
#define HTL_XMLWRITER_H
...
namespace HTL{
	...
	class HTL_DLLAPI HtlXMLWriter
	{
	public:

		//PUBLIC CONSTRUCTORS & DESTRUCTOR/////////////////////////////
		HtlXMLWriter(void);
		virtual ~HtlXMLWriter(void);
		...
		virtual int SaveXMLTree(HtlElement * ptrCurrTop, std::string & strOutput, bool blnWithFormatting);
		virtual int SaveXMLTree(HtlElement * ptrCurrTop, std::ostream & strStreamOut, bool blnWithFormatting);
		virtual int SaveXMLTree(HtlElement * ptrCurrTop, std::ofstream & strStreamOut, bool blnWithFormatting);
		//!Update the indexes
		...
		int SaveXMLElement(HtlElement * ptrElement, std::string & strOutput, bool blnWithFormatting);
		//!Save the XML Comment based with or without formatting
		int SaveXMLComment(HtlComment * ptrComment, std::string & strOutput, bool blnWithFormatting);
		//!Save the XML Process based with or without formatting
		int SaveXMLProcess(HtlProcess * ptrProcess, std::string & strOutput, bool blnWithFormatting);
