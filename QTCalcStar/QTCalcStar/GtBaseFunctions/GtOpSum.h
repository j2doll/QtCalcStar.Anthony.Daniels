...
#ifndef GtCalc_OP_SUM_H
#define GtCalc_OP_SUM_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		static bool blnGtOpSum_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpSum>("sum");
		static bool blnGtOpSum2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpSum>("SUM");
	}//end namespace
}//end namespace GT
