...
#ifndef GtCalc_OP_FACTORIAL_H
#define GtCalc_OP_FACTORIAL_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpFactorial : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpFactorial();
		...
		static bool blnGtOpFactorial_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpFactorial>("fact");
		static bool blnGtOpFactorial2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpFactorial>("FACT");
	}//end namespace
}//end namespace GT
#endif