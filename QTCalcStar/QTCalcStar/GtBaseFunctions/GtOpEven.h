...
#ifndef GtCalc_OP_EVEN_H
#define GtCalc_OP_EVEN_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpEven : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpEven();
		...
		static bool blnGtOpEven_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpEven>("even");
		static bool blnGtOpEven2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpEven>("EVEN");
	}//end namespace
}//end namespace GT
#endif