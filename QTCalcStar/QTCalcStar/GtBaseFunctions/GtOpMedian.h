...
#ifndef GtCalc_OP_MEDIAN_H
#define GtCalc_OP_MEDIAN_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpMedian : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpMedian();
		...
		static bool blnGtOpMedian_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMedian>("median");
		static bool blnGtOpMedian2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMedian>("MEDIAN");
	}//end namespace
}//end namespace GT
