...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpENumber::GtOpENumber() : GtOpBase()
		{
			m_intNumInputs = 0;
		};
		//!Default Destructor
		GtOpENumber::~GtOpENumber() {};

		//!Perform the operation on the stack
		int GtOpENumber::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
			...
			try {
				this->ValidOpInputs(arrObjCalcStack, blnValid, intCurrPos, 0);
