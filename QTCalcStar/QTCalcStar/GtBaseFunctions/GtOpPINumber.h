...
#ifndef GtCalc_OP_PI_NUMBER_H
#define GtCalc_OP_PI_NUMBER_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpPINumber : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpPINumber();
		...
		static bool blnGtOpPINumber_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpPINumber>("pi");
		static bool blnGtOpPINumber2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpPINumber>("PI");
