...
#ifndef GtCalc_OP_RANGE_H
#define GtCalc_OP_RANGE_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpRange : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpRange();
		...
		static bool blnGtOpRange_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpRange>("rg");
		static bool blnGtOpRange2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpRange>("RG");
	}//end namespace
}//end namespace GT
