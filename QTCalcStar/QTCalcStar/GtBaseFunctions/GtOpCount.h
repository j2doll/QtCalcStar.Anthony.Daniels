...
#ifndef GtCalc_OP_COUNT_H
#define GtCalc_OP_COUNT_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpCount : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpCount();
			...
			bool IsNumeric(string & strInput);
		...
		static bool blnGtOpCount_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpCount>("count");
		static bool blnGtOpCount2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpCount>("COUNT");
	}//end namespace
}//end namespace GT
