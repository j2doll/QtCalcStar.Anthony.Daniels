...
#ifndef GtCalc_OP_SIGN_H
#define GtCalc_OP_SIGN_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpSign : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpSign();
		...
		static bool blnGtOpSign_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpSign>("sign");
		static bool blnGtOpSign2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpSign>("SIGN");
	}//end namespace
}//end namespace GT
#endif