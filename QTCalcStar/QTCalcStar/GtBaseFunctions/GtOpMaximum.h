...
#ifndef GtCalc_OP_MAXIMUM_H
#define GtCalc_OP_MAXIMUM_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpMaximum : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpMaximum();
		...
		static bool blnGtOpMaximum_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMaximum>("max");
		static bool blnGtOpMaximum2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMaximum>("MAX");
	}//end namespace
}//end namespace GT
