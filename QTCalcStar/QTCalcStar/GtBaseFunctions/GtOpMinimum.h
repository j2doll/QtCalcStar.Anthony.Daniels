...
#ifndef GtCalc_OP_MINIMUM_H
#define GtCalc_OP_MINIMUM_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpMinimum : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpMinimum();
		...
		static bool blnGtOpMinimum_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMinimum>("min");
		static bool blnGtOpMinimum2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMinimum>("MIN");
	}//end namespace
}//end namespace GT
