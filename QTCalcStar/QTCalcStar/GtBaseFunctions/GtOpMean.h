...
#ifndef GtCalc_OP_MEAN_H
#define GtCalc_OP_MEAN_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpMean : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpMean();
		...
		static bool blnGtOpMean_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMean>("mean");
		static bool blnGtOpMean2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMean>("MEAN");
	}//end namespace
}//end namespace GT
