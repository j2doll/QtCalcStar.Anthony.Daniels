...
#ifndef GtCalc_OP_RowCol_H
#define GtCalc_OP_RowCol_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpRowCol : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpRowCol();
		...
		static bool blnGtOpRowCol_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpRowCol>("rc");
		static bool blnGtOpRowCol2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpRowCol>("RC");
	}//end namespace
}//end namespace GT
