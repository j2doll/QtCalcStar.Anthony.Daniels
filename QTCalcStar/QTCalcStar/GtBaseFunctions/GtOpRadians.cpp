...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpRadians::GtOpRadians() : GtOpBase()
		{
			m_intNumInputs = 1;
		};
		//!Default Destructor
		GtOpRadians::~GtOpRadians() {};

		//!Perform the operation on the stack
		int GtOpRadians::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
