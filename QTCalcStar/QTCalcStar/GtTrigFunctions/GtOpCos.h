...
#ifndef GtCalc_OP_Cos_H
#define GtCalc_OP_Cos_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		static bool blnGtOpCos_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpCos>("cos");
		static bool blnGtOpCos2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpCos>("GtOpCos");
	}//end namespace
}//end namespace GT
#endif //GtCalc_OP_Cos_H
