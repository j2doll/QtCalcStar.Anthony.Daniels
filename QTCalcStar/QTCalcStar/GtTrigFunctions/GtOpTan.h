...
#ifndef GtCalc_OP_Tan_H
#define GtCalc_OP_Tan_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		static bool blnGtOpTan_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpTan>("tan");
		static bool blnGtOpTan2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpTan>("GtOpTan");
	}//end namespace
}//end namespace GT
#endif //GtCalc_OP_Tan_H
