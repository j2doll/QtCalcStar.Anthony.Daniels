...
#ifndef GtCalc_OP_ACosH_H
#define GtCalc_OP_ACosH_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpACosH : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpACosH();
		...
		static bool blnGtOpACosH_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpACosH>("acosh");
		static bool blnGtOpACosH2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpACosH>("GtOpACosH");
	}//end namespace
}//end namespace GT
#endif //GtCalc_OP_ACosH_H
