...
#ifndef GtCalc_OP_TanH_H
#define GtCalc_OP_TanH_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpTanH : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpTanH();
		...
		static bool blnGtOpTanH_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpTanH>("tanh");
		static bool blnGtOpTanH2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpTanH>("GtOpTanH");
	}//end namespace
}//end namespace GT
#endif //GtCalc_OP_TanH_H
