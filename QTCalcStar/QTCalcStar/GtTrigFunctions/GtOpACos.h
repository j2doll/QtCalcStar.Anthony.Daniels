...
#ifndef GtCalc_OP_ACos_H
#define GtCalc_OP_ACos_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpACos : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpACos();
		...
		static bool blnGtOpACos_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpACos>("acos");
		static bool blnGtOpACos2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpACos>("GtOpACos");
	}//end namespace
}//end namespace GT
#endif //GtCalc_OP_ACos_H
