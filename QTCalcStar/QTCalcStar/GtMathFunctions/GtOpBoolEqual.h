...
#ifndef GtCalc_OP_BoolEqual_H
#define GtCalc_OP_BoolEqual_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpBoolEqual : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpBoolEqual();
		...
		static bool blnGtOpBoolEqual_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpBoolEqual>("==");
		static bool blnGtOpBoolEqual2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpBoolEqual>("EQ");
		static bool blnGtOpBoolEqual3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpBoolEqual>("GtOpBoolEqual");
	}//end namespace
}//end namespace gt
#endif