...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpSquareRoot::GtOpSquareRoot() : GtOpBase()
		{
			m_intNumInputs = 1;
		};
		//!Default Destructor
		GtOpSquareRoot::~GtOpSquareRoot() {};

		//!Perform the operation on the stack
		int GtOpSquareRoot::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
			//FUNCTION: sqrt(input)
