...
#ifndef GtCalc_OP_Truncate_H
#define GtCalc_OP_Truncate_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpTruncate : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpTruncate();
		...
		static bool blnGtOpTruncate_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpTruncate>("trunc");
		static bool blnGtOpTruncate2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpTruncate>("GtOpTruncate");
	}//end namespace
}//end namespace GT
#endif //GtCalc_OP_Truncate_H
