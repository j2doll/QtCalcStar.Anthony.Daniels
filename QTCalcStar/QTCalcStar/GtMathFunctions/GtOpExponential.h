...
#ifndef GtCalc_OP_Exponential_H
#define GtCalc_OP_Exponential_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpExponential : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpExponential();
		...
		static bool blnGtOpExponential_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpExponential>("exp");
		static bool blnGtOpExponential2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpExponential>("GtOpExponential");
	}//end namespace
}//end namespace gt
#endif //GtCalc_OP_Exponential_H
