...
#ifndef GtCalc_OP_Power_H
#define GtCalc_OP_Power_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpPower : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpPower();
		...
		static bool blnGtOpPower_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpPower>("^");
		static bool blnGtOpPower2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpPower>("pow");
		static bool blnGtOpPower3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpPower>("GtOpPower");
	}//end namespace
}//end namespace GT
