...
namespace GT
{
	...
	{
		//!Default Constructor
		GtOpLessThanEqual::GtOpLessThanEqual() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpLessThanEqual::~GtOpLessThanEqual() {};

		//!Perform the operation on the stack
		int GtOpLessThanEqual::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
