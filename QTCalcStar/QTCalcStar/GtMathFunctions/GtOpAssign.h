...
#ifndef GtCalc_OP_ASSIGN_H
#define GtCalc_OP_ASSIGN_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpAssign : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpAssign();
		...
		static bool blnGtOpAssign_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpAssign>("=");
		static bool blnGtOpAssign2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpAssign>("ASSIGN");
		static bool blnGtOpAssign3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpAssign>("GtOpAssign");
	}//end namespace
}//end namespace
#endif