...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpAbsoluteValue::GtOpAbsoluteValue() : GtOpBase()
		{
			m_intNumInputs = 1;
		};
		//!Default Destructor
		GtOpAbsoluteValue::~GtOpAbsoluteValue() {};

		//!Perform the operation on the stack
		int GtOpAbsoluteValue::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
			//FUNCTION: abs(input)
