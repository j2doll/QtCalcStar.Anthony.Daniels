...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpDivide::GtOpDivide() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpDivide::~GtOpDivide() {};

		//!Perform the operation on the stack
		int GtOpDivide::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
