...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpSubtract::GtOpSubtract() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpSubtract::~GtOpSubtract() {};

		//!Perform the operation on the stack
		int GtOpSubtract::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
