...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpNegative::GtOpNegative() : GtOpBase()
		{
			m_intNumInputs = 1;
		};
		//!Default Destructor
		GtOpNegative::~GtOpNegative() {};

		//!Perform the operation on the stack
		int GtOpNegative::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
