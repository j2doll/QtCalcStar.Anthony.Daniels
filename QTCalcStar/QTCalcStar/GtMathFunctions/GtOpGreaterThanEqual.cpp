...
#include ".\GtOpGreaterThanEqual.h"
...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpGreaterThanEqual::GtOpGreaterThanEqual() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpGreaterThanEqual::~GtOpGreaterThanEqual() {};

		//!Perform the operation on the stack
		int GtOpGreaterThanEqual::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
