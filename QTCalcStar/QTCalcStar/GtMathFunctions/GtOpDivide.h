...
#ifndef GtCalc_OP_Divide_H
#define GtCalc_OP_Divide_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpDivide : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpDivide();
		...
		static bool blnGtOpDivide_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpDivide>("/");
		static bool blnGtOpDivide2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpDivide>("DIV");
		static bool blnGtOpDivide3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpDivide>("GtOpDivide");
	}//end namespace
}//end namespace
#endif