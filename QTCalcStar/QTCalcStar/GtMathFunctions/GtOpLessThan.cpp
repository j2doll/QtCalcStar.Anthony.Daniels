...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpLessThan::GtOpLessThan() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpLessThan::~GtOpLessThan() {};

		//!Perform the operation on the stack
		int GtOpLessThan::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
