...
#ifndef GtCalc_OP_LessThanEqual_H
#define GtCalc_OP_LessThanEqual_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpLessThanEqual : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpLessThanEqual();
		...
		static bool blnGtOpLessThanEqual_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLessThanEqual>("<=");
		static bool blnGtOpLessThanEqual2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLessThanEqual>("LTE");
		static bool blnGtOpLessThanEqual3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLessThanEqual>("GtOpLessThanEqual");
	}//end namespace
}//end namespace gt
#endif