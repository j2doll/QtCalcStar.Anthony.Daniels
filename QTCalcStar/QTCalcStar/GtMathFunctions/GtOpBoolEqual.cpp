...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpBoolEqual::GtOpBoolEqual() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpBoolEqual::~GtOpBoolEqual() {};

		//!Perform the operation on the stack
		int GtOpBoolEqual::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
