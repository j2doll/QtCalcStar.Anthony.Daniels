...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpGreaterThan::GtOpGreaterThan() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpGreaterThan::~GtOpGreaterThan() {};

		//!Perform the operation on the stack
		int GtOpGreaterThan::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
