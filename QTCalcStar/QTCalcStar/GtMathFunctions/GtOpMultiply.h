...
#ifndef GtCalc_OP_Multiply_H
#define GtCalc_OP_Multiply_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpMultiply : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpMultiply();
		...
		static bool blnGtOpMultiply_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMultiply>("*");
		static bool blnGtOpMultiply2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMultiply>("MULT");
		static bool blnGtOpMultiply3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpMultiply>("GtOpMultiply");
	}//end namespace
}//end namespace GT
#endif