...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpNegative : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpNegative();
		...
		static bool blnGtOpNegative_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpNegative>("-");
		static bool blnGtOpNegative2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpNegative>("NEG");
		static bool blnGtOpNegative3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpNegative>("GtOpNegative");
	}//end namespace
}//end namespace GT
#endif