...
#ifndef GtCalc_OP_Log10_H
#define GtCalc_OP_Log10_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpLog10 : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpLog10();
		...
		static bool blnGtOpLog10_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLog10>("log10");
		static bool blnGtOpLog102_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLog10>("GtOpLog10");
	}//end namespace
}//end namespace
#endif //GtCalc_OP_Log10_H
