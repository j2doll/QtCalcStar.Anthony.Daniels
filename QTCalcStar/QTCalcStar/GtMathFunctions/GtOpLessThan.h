...
#ifndef GtCalc_OP_LessThan_H
#define GtCalc_OP_LessThan_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpLessThan : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpLessThan();
		...
		static bool blnGtOpLessThan_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLessThan>("<");
		static bool blnGtOpLessThan2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLessThan>("LT");
		static bool blnGtOpLessThan3_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpLessThan>("GtOpLessThan");
	}//end namespace
}//end namespace gt
#endif