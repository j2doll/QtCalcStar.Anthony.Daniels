...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpBoolNot::GtOpBoolNot() : GtOpBase()
		{
			m_intNumInputs = 1;
		};
		//!Default Destructor
		GtOpBoolNot::~GtOpBoolNot() {};

		//!Perform the operation on the stack
		int GtOpBoolNot::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
