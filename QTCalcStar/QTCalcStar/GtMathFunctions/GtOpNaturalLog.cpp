...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpNaturalLog::GtOpNaturalLog() : GtOpBase()
		{
			m_intNumInputs = 1;
		};
		//!Default Destructor
		GtOpNaturalLog::~GtOpNaturalLog() {};

		//!Perform the operation on the stack
		int GtOpNaturalLog::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
