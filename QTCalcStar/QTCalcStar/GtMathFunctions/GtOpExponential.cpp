...
namespace GT
{
	...
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpExponential::GtOpExponential() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpExponential::~GtOpExponential() {};

		//!Perform the operation on the stack
		int GtOpExponential::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
			//FUNCTION: exp(input)
