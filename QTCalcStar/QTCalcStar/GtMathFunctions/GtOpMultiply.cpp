...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpMultiply::GtOpMultiply() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpMultiply::~GtOpMultiply() {};

		//!Perform the operation on the stack
		int GtOpMultiply::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
