...
#ifndef GtCalc_OP_Floor_H
#define GtCalc_OP_Floor_H
...
namespace GT
{
	namespace GtCalc
	{
		...
		class GtOpFloor : public GtOpBase
		{
		public:
			//!Default Constructor
			GtOpFloor();
		...
		static bool blnGtOpFloor_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpFloor>("floor");
		static bool blnGtOpFloor2_Registered = GtCalc::GetOpBaseFactoryPtr()->Register<GtOpFloor>("GtOpFloor");
	}//end namespace
}//end namespace gt
#endif //GtCalc_OP_Floor_H
