...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpBoolOr::GtOpBoolOr() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpBoolOr::~GtOpBoolOr() {};

		//!Perform the operation on the stack
		int GtOpBoolOr::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
