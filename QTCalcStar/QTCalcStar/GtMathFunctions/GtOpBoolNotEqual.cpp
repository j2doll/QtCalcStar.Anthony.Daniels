...
namespace GT
{
	namespace GtCalc
	{
		...
		//!Default Constructor
		GtOpBoolNotEqual::GtOpBoolNotEqual() : GtOpBase()
		{
			m_intNumInputs = 2;
		};
		//!Default Destructor
		GtOpBoolNotEqual::~GtOpBoolNotEqual() {};

		//!Perform the operation on the stack
		int GtOpBoolNotEqual::OpEval(std::vector<GtRpnUnit> & arrObjCalcStack, bool & blnCalcSuccessful, int intCurrPos)
		{
